...
filename = resource_path(os.path.join("D:/tongcheng/image"))
...
class Ui_MainWindow(QtWidgets.QMainWindow,object):
    def setupUi(self, MainWindow):
        ...
        self.page.setStyleSheet("QWidget{background-image:url(%s);border:none}"%resource_path(os.path.join("image",'btl.png')))

        #关闭按钮
        self.pushButton_1 = QtWidgets.QPushButton(self.page)
        self.pushButton_1.setObjectName("pushButton_1")
        self.pushButton_1.setGeometry(1034,0,31,33)
        self.pushButton_1.setStyleSheet("QPushButton{background-image:url(%s)} QWidget:hover{background-image:url(%s);border:none} QWidget:pressed{background-image:url(%s);border:none}"%(resource_path(os.path.join("image",'gb_dl.png')),resource_path(os.path.join("image",'gbhover.png')),resource_path(os.path.join("image",'gbpressed.png'))))
        ...
        self.pushButton_2.setStyleSheet("QPushButton{background-image:url(%s)} QWidget:hover{background-image:url(%s);border:none} QWidget:pressed{background-image:url(%s);border:none}"%(resource_path(os.path.join("image",'zxh_dl.png')),resource_path(os.path.join("image",'zxhhover.png')),resource_path(os.path.join("image",'zxhpressed.png'))))
        ...
        self.textBrowser.setStyleSheet("background-image: url(%s);"%resource_path(os.path.join("image",'logo3.jpg')))
    ...
    def WJ_Window(self):
        ...
        self.centralWidget_w.setStyleSheet("background-image: url(%s);"%resource_path(os.path.join("image",'zc_bj.png')))

        # 添加标题栏
        self.page_ww = QtWidgets.QWidget(self.dialog_w)
        self.page_ww.setObjectName("page")
        self.page_ww.setGeometry(QtCore.QRect(0, 0, 500, 33))
        self.page_ww.setStyleSheet("QWidget{background-image:url('%s');border:none}"%resource_path(os.path.join("image",'zc_btl.png')))

        # 设置关闭按钮
        self.pushButton_wg = QtWidgets.QPushButton(self.page_ww)
        self.pushButton_wg.setObjectName("pushButton_wg")
        self.pushButton_wg.setGeometry(QtCore.QRect(468, 0, 31, 33))
        self.pushButton_wg.setStyleSheet("QPushButton{background-image:url(%s)} QWidget:hover{background-image:url(%s);border:none} QWidget:pressed{background-image:url(%s);border:none}"%(resource_path(os.path.join("image",'gb.png')),resource_path(os.path.join("image",'gbhover.png')),resource_path(os.path.join("image",'gbpressed.png'))))
        self.pushButton_wg.clicked.connect(self.dialog_w.close)

        # 设置最小化按钮
        self.pushButton_wz = QtWidgets.QPushButton(self.page_ww)
        self.pushButton_wz.setObjectName("pushButton_z")
        self.pushButton_wz.setGeometry(440,0,31,33)
        self.pushButton_wz.setStyleSheet("QPushButton{background-image:url(%s)} QWidget:hover{background-image:url(%s);border:none} QWidget:pressed{background-image:url(%s);border:none}"%(resource_path(os.path.join("image",'zxh.png')),resource_path(os.path.join("image",'zxhhover.png')),resource_path(os.path.join("image",'zxhpressed.png'))))
        ...
        self.pushButton_fs.setStyleSheet("QPushButton{background-image:url(%s)}"%resource_path(os.path.join("image",'fsyzman_bj.png')))
        ...
        self.pushButton_x.setStyleSheet("QPushButton{background-image:url(%s)}"%resource_path(os.path.join("image",'wjqd_bj.png')))
    ...
    def FSyanzhengma(self):
        ...
        try:
            if int(phone) is True or len(phone) != 11:
                ...
                client = smsclient.ZhenziSmsClient(apiUrl,100003,'ODgzNDdkMTUtODgzOS00YjJiLThmNTEtYTZjYWMwODVhOTE5')
                sjh = "%s"%phone
    ...
    def YHM_window(self):
        ...
        self.centralwidget_y.setStyleSheet("background-image:url(%s);"%resource_path(os.path.join("image",'shu_zhang_bj.png')))
        ...
        self.page_y.setStyleSheet("QWidget{background-image:url(%s);border:none}"%resource_path(os.path.join("image",'cw_btl.png')))
        ...
        self.pushButton_5.setStyleSheet(
            "QPushButton{background-image:url(%s)}  QWidget:hover{background-image:url(%s);border:none} QWidget:pressed{background-image:url(%s);border:none}"%(resource_path(os.path.join("image",'gb_cw.png')),resource_path(os.path.join("image",'gbhover.png')),resource_path(os.path.join("image",'gbpressed.png'))))
        ...
        self.pushButton_6.setStyleSheet("QPushButton{background-image:url(%s)}"%resource_path(os.path.join("image",'cwan.png')))
    ...
    def SMM_Window(self):
        ...
        self.centralwidget_s.setStyleSheet("background-image:url(%s);"%resource_path(os.path.join("image",'shu_mm_bj.png')))
        ...
        self.page_s.setStyleSheet("QWidget{background-image:url(%s);border:none}"%resource_path(os.path.join("image",'cw_btl.png')))
        ...
        self.pushButton_Sgb.setStyleSheet("QPushButton{background-image:url(%s)}  QWidget:hover{background-image:url(%s);border:none} QWidget:pressed{background-image:url(%s);border:none}"%(resource_path(os.path.join("image",'gb_cw.png')),resource_path(os.path.join("image",'gbhover.png')),resource_path(os.path.join("image",'gbpressed.png'))))
        ...
        self.pushButton_sgb.setStyleSheet("QPushButton{background-image:url(%s)}"%resource_path(os.path.join("image",'cwan.png')))
        self.pushButton_sgb.clicked.connect(self.dialog_s.close)
    ...
    def WJZ_Window(self):
        ...
        self.centralwidget_e.setStyleSheet("background-image:url(%s);"%resource_path(os.path.join("image",'wj_yhmbcz_bj.png')))
        ...
        self.page_e.setStyleSheet("QWidget{background-image:url(%s);border:none}"%resource_path(os.path.join("image",'cw_btl.png')))
        ...
        self.pushButton_Egb.setStyleSheet("QPushButton{background-image:url(%s)}"%resource_path(os.path.join("image",'cwan.png')))
        self.pushButton_Egb.clicked.connect(self.dialog_e.close)
    ...
    def YZMC_Window(self):
        ...
        self.centralwidget_q.setStyleSheet("background-image:url(%s);"%resource_path(os.path.join("image",'wj_yzmcw_bj.png')))
        ...
        self.page_q.setStyleSheet("QWidget{background-image:url(%s);border:none}"%resource_path(os.path.join("image",'cw_btl.png')))
        ...
        self.pushButton_Sqgb.setStyleSheet("QPushButton{background-image:url(%s)}  QWidget:hover{background-image:url(%s);border:none} QWidget:pressed{background-image:url(%s);border:none}"%(resource_path(os.path.join("image",'gb_cw.png')),resource_path(os.path.join("image",'gbhover.png')),resource_path(os.path.join("image",'gbpressed.png'))))        
        ...
        self.pushButton_sqgb.setStyleSheet("QPushButton{background-image:url(%s)}"%resource_path(os.path.join("image",'cwan.png')))
        self.pushButton_sqgb.clicked.connect(self.dialog_q.close)
...
class Ui_MainWindow2(QtWidgets.QDialog):
    ...
    def ZC_Window(self):
        ...
        self.textBrowser.setStyleSheet("background-image: url(%s);"%resource_path(os.path.join("image",'zc_bj.png')))
        self.textBrowser.setObjectName("textBrowser")
        ...
        self.page.setStyleSheet("QWidget{background-image:url(%s);border:none}"%resource_path(os.path.join("image",'zc_btl.png')))
        ...
        self.pushButton_g.setStyleSheet("QPushButton{background-image:url(%s)} QWidget:hover{background-image:url(%s);border:none} QWidget:pressed{background-image:url(%s);border:none}"%(resource_path(os.path.join("image",'gb.png')),resource_path(os.path.join("image",'gbhover.png')),resource_path(os.path.join("image",'gbpressed.png'))))
        ...
        self.pushButton_z.setStyleSheet("QPushButton{background-image:url(%s)} QWidget:hover{background-image:url(%s);border:none} QWidget:pressed{background-image:url(%s);border:none}"%(resource_path(os.path.join("image",'zxh.png')),resource_path(os.path.join("image",'zxhhover.png')),resource_path(os.path.join("image",'zxhpressed.png'))))
        ...
        self.pushButton_yzs.setStyleSheet("QPushButton{background-image:url(%s)}"%resource_path(os.path.join("image",'fsyzman_bj.png')))
        ...
        self.pushButton_2.setStyleSheet("QPushButton{background-image:url(%s)}"%resource_path(os.path.join("image",'zcan_bj.png')))
    ...
    def CWQQ_Window(self):
        ...
        self.centralwidget_r.setStyleSheet("background-image:url(%s);"%resource_path(os.path.join("image",'wj_yzmcw_bj.png')))
        ...
        self.page_r.setStyleSheet("QWidget{background-image:url(%s);border:none}"%resource_path(os.path.join("image",'cw_btl.png')))
        ...
        self.pushButton_crgb.setStyleSheet("QPushButton{background-image:url(%s)}  QWidget:hover{background-image:url(%s);border:none} QWidget:pressed{background-image:url(%s);border:none}"%(resource_path(os.path.join("image",'gb_cw.png')),resource_path(os.path.join("image",'gbhover.png')),resource_path(os.path.join("image",'gbpressed.png'))))        
        ...
        self.pushButton_qrgb.setStyleSheet("QPushButton{background-image:url(%s)}"%resource_path(os.path.join("image",'cwan.png')))
    ...
    def CWSS_Window(self):
        ...
        self.centralwidget_ss.setStyleSheet("background-image:url(%s);"%resource_path(os.path.join("image",'zc_sjyzc_bj.png')))
        ...
        self.page_ss.setStyleSheet("QWidget{background-image:url(%s);border:none}"%resource_path(os.path.join("image",'cw_btl.png')))
        ...
        self.pushButton_csgb.setStyleSheet("QPushButton{background-image:url(%s)}  QWidget:hover{background-image:url(%s);border:none} QWidget:pressed{background-image:url(%s);border:none}"%(resource_path(os.path.join("image",'gb_cw.png')),resource_path(os.path.join("image",'gbhover.png')),resource_path(os.path.join("image",'gbpressed.png'))))        
        ...
        self.pushButton_qsgb.setStyleSheet("QPushButton{background-image:url(%s)}"%resource_path(os.path.join("image",'cwan.png')))
    ...
    def CWQ_Window(self):
        ...
        self.centralwidget_q.setGeometry(QtCore.QRect(0,33,330,300))
        self.centralwidget_q.setObjectName("centralwidget_q")
        self.centralwidget_q.setStyleSheet("background-image:url(%s);"%resource_path(os.path.join("image",'zhuce_tx_bj.png')))
        ...
        self.pushButton_cqgb.setStyleSheet("QPushButton{background-image:url(%s)}  QWidget:hover{background-image:url(%s);border:none} QWidget:pressed{background-image:url(%s);border:none}"%(resource_path(os.path.join("image",'gb_cw.png')),resource_path(os.path.join("image",'gbhover.png')),resource_path(os.path.join("image",'gbpressed.png'))))        
        ...
        self.pushButton_qqgb.setStyleSheet("QPushButton{background-image:url(%s)}"%resource_path(os.path.join("image",'cwan.png')))
    ...
    def CWJ_Window(self):
        ...
        self.centralwidget_j.setStyleSheet("background-image:url(%s);"%resource_path(os.path.join("image",'zhuce_mmyz_bj.png')))
        ...
        self.page_j.setStyleSheet("QWidget{background-image:url(%s);border:none}"%resource_path(os.path.join("image",'cw_btl.png')))
        ...
        self.pushButton_cjgb.setStyleSheet("QPushButton{background-image:url(%s)}  QWidget:hover{background-image:url(%s);border:none} QWidget:pressed{background-image:url(%s);border:none}"%(resource_path(os.path.join("image",'gb_cw.png')),resource_path(os.path.join("image",'gbhover.png')),resource_path(os.path.join("image",'gbpressed.png'))))        
        ...
        self.pushButton_qjgb.setStyleSheet("QPushButton{background-image:url(%s)}"%resource_path(os.path.join("image",'cwan.png')))
    ...
    def CWH_Window(self):
        ...
        self.centralwidget_h.setStyleSheet("background-image:url(%s);"%resource_path(os.path.join("image",'shu_yhcz_bj.png')))
        ...
        self.page_h.setStyleSheet("QWidget{background-image:url(%s);border:none}"%resource_path(os.path.join("image",'cw_btl.png')))
        ...
        self.pushButton_chgb.setStyleSheet("QPushButton{background-image:url(%s)}  QWidget:hover{background-image:url(%s);border:none} QWidget:pressed{background-image:url(%s);border:none}"%(resource_path(os.path.join("image",'gb_cw.png')),resource_path(os.path.join("image",'gbhover.png')),resource_path(os.path.join("image",'gbpressed.png'))))        
        ...
        self.pushButton_qhgb.setStyleSheet("QPushButton{background-image:url(%s)}"%resource_path(os.path.join("image",'cwan.png')))
    ...
    def CWO_Window(self):
        ...
        self.centralwidget_o.setStyleSheet("background-image:url(%s);"%resource_path(os.path.join("image",'shu_sjh_bj.png')))
        ...
        self.page_o.setStyleSheet("QWidget{background-image:url(%s);border:none}"%resource_path(os.path.join("image",'cw_btl.png')))
        ...
        self.pushButton_cogb.setStyleSheet("QPushButton{background-image:url(%s)}  QWidget:hover{background-image:url(%s);border:none} QWidget:pressed{background-image:url(%s);border:none}"%(resource_path(os.path.join("image",'gb_cw.png')),resource_path(os.path.join("image",'gbhover.png')),resource_path(os.path.join("image",'gbpressed.png'))))        
        ...
        self.pushButton_qogb.setStyleSheet("QPushButton{background-image:url(%s)}"%resource_path(os.path.join("image",'cwan.png')))
    ...
    def successfully(self):
        ...
        self.textBrowser1.setStyleSheet("background-image: url(%s);"%resource_path(os.path.join("image",'zccc_bj.png')))
        ...
        self.page_2.setStyleSheet("QWidget{background-image:url(%s);border:none}"%resource_path(os.path.join("image",'zccc_btl.png')))
        ...
        self.pushButton_s.setStyleSheet("QPushButton{background-image:url(%s)}"%resource_path(os.path.join("image",'zcccan.btl.png')))
        _translate = QtCore.QCoreApplication.translate
        ...
        self.pushButton_g1.setStyleSheet("QPushButton{background-image:url(%s)}  QWidget:hover{background-image:url(%s);border:none} QWidget:pressed{background-image:url(%s);border:none}"%(resource_path(os.path.join("image",'gb_zccc.png')),resource_path(os.path.join("image",'gb_zccchover.png')),resource_path(os.path.join("image",'gb_zcccpressed.png'))))        
        # gb_zccc.png  gb_zccchover.png  gb_zcccpressed.png
        ...
        self.pushButton_g1.setStyleSheet("QPushButton{background-image:url(%s)}  QWidget:hover{background-image:url(%s);border:none} QWidget:pressed{background-image:url(%s);border:none}"%(resource_path(os.path.join("image",'zxh_accc.png')),resource_path(os.path.join("image",'zxh_accchover.png')),resource_path(os.path.join("image",'zxh_acccpressed.png'))))        
        # zxh_accc.png  zxh_accchover.png  zxh_acccpressed.png
    ...
    def setupUi_d(self):
        ...
        self.centralwidget_d.setStyleSheet("background-image: url(%s);"%resource_path(os.path.join("image",'gz_bj.png')))
        ...
        self.page_d.setStyleSheet("QWidget{background-image:url(%s);border:none}"%resource_path(os.path.join("image",'gz_btl.png')))
        ...
        self.pushButton_gz.setStyleSheet("QPushButton{background-image:url(%s)}  QWidget:hover{background-image:url(%s);border:none} QWidget:pressed{background-image:url(%s);border:none}"%(resource_path(os.path.join("image",'gb_gz.png')),resource_path(os.path.join("image",'gbhover.png')),resource_path(os.path.join("image",'gbpressed.png'))))        
        ...
        self.pushButton_zz.setStyleSheet("QPushButton{background-image:url(%s)}  QWidget:hover{background-image:url(%s);border:none} QWidget:pressed{background-image:url(%s);border:none}"%(resource_path(os.path.join("image",'zxh_gz.png')),resource_path(os.path.join("image",'zxhhover.png')),resource_path(os.path.join("image",'zxhpressed.png'))))        
        # zxh_gz.png  zxhhover.png  zxhpressed.png
    ...
    def retranslateUi_d(self):
        ...
        self.pushButton_bj.setStyleSheet("QPushButton{background-image:url(%s);border:none}"%resource_path(os.path.join("image",'bjan_bj.png')))
        self.pushButton_hz.setText(_translate("MainWindow","杭州"))
        self.pushButton_hz.setStyleSheet("QPushButton{background-image:url(%s);border:none}"%resource_path(os.path.join("image",'hzan_bj.png')))
        self.pushButton_sz.setText(_translate("MainWindow","深圳"))
        self.pushButton_sz.setStyleSheet("QPushButton{background-image:url(%s);border:none}"%resource_path(os.path.join("image",'szan_bj.png')))
        self.pushButton_sh.setText(_translate("MainWindow","上海"))
        self.pushButton_sh.setStyleSheet("QPushButton{background-image:url(%s);border:none}"%resource_path(os.path.join("image",'shan_bj.png')))
        self.pushButton_Cgz.setText(_translate("MainWindow","广州"))
        self.pushButton_Cgz.setStyleSheet("QPushButton{background-image:url(%s);border:none}"%resource_path(os.path.join("image",'gzan_bj.png')))
    ...
    def CW_Window(self):
        ...
        self.centralwidget_c.setStyleSheet("background-image:url(%s);"%resource_path(os.path.join("image",'cw_bj.png')))
        ...
        self.page_c.setStyleSheet("QWidget{background-image:url(%s);border:none}"%resource_path(os.path.join("image",'cw_btl.png')))
        ...
        self.pushButton_cgb.setStyleSheet("QPushButton{background-image:url(%s)}  QWidget:hover{background-image:url(%s);border:none} QWidget:pressed{background-image:url(%s);border:none}"%(resource_path(os.path.join("image",'gb_cw.png')),resource_path(os.path.join("image",'gbhover.png')),resource_path(os.path.join("image",'gbpressed.png'))))        
        ...
        self.pushButton_qgb.setStyleSheet("QPushButton{background-image:url(%s)}"%resource_path(os.path.join("image",'cwan.png')))
